...
FString UApolloGameInstance::GetCurrentMissionSaveSlotFilePath()
{
	return CurrentMissionSaveSlotFilePath;
}
...
TArray<FString> UApolloGameInstance::GetPossibleMissionSaveSlots()
{
	return MissionSaveSlotsList;
}
...
void UApolloGameInstance::SetCurrentMissionSaves(TArray<FString> NewValidSaveNames)
{
	CurrentMissionSaveSlotsList = NewValidSaveNames;
}
