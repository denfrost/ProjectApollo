...
public:
	...
	//Get the name of the current Save Slot FilePath
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Save System")
		FString GetCurrentMissionSaveSlotFilePath();
	...
	//Get the name of the possible Save Slots for mission Mode
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Save System")
		TArray<FString> GetPossibleMissionSaveSlots();
	...
	//Set the names of the save slots on disk
	UFUNCTION(BlueprintCallable, Category = "Save System")
		void SetCurrentMissionSaves(TArray<FString> NewValidSaveNames);
...
protected:
	...
	//String of the current Save Mission Slot with the file path
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Save System|Slot")
		FString CurrentMissionSaveSlotFilePath;

	//String of the current Save Slot for Mission Mode
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Save System|Slot")
		FString CurrentMissionSaveSlot;
	...
	//The names of all save slots for mission mode the player has on disk with file path
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Save System|Slot")
		TArray<FString> CurrentMissionSaveSlotsList;

	//The names of all save slots for mission mode the player can make
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Save System|Slot")
		TArray<FString> MissionSaveSlotsList;
